...
- 실제 공격·이상행위와 조치 전·후 동일 조건 재검증
- 시나리오와 연결된 최소 Metric Filter·Alarm·알림
- WAF `COUNT`에서 `BLOCK`으로 전환할 조건과 Rollback 증거
- 다음 Daily Up에서 Health Check Noise 보정과 Collector 자동 복원 재검증
