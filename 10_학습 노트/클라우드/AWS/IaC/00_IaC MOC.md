...
- 최신 정리 노트: [[Terraform Module 종합 구성 실습 v14.0]]
  - Networks·S3·Servers·ELB Child Module의 책임과 Input/Output 흐름을 정리한다.
  - 강사 답지의 정적 분석까지 반영했으며 전체 `plan`, `apply` 검증은 보류 중이다.
- 현재 강의: 15번 진도 진행 중이며 아직 별도 노트로 정리하지 않았다.
- 다음 독립 학습 후보:
...
- [[Terraform Module 종합 구성 실습 v14.0]] - Networks·S3·Servers·ELB 책임 경계와 Module 간 데이터 흐름을 Stage/Prod Root Module에서 조립하는 최신 누적 실습
