...
- 현재 수업 진도: [[Terraform Module 구성 실습 v11.0]]
  - VPC와 Subnet을 Local Child Module로 분리한다.
  - VPC Module Output을 Subnet Module Input으로 전달한다.
  - Stage와 Prod Root Module에서 같은 Child Module 구현을 재사용한다.
