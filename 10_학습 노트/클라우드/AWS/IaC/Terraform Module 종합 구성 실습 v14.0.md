...
> **v14.0 부제:** S3·ELB 책임 분리와 네 Child Module 종합 조립

## 목적

이 노트는 v11.0의 Local Module 기본 구조, v12.0의 Networks·Servers 책임 분리, v13.0의 반복 Resource와 Collection 계약을 그대로 계승한다. 이어서 강사의 `14_module(s3,elb)_답지`를 기준으로 S3·IAM 책임을 별도 Child Module로 이동하고, ELB Child Module을 추가해 Stage/Prod Root Module에서 네 Module을 조립하는 구조를 분석한다.
