...
- p.21-p.23 Sidecar·Pod Network 실습
- p.24-p.30 Label·Selector 실습
...
- Pod Scheduling 이후의 실습은 [[Lab_EKS Pod Scheduling과 Node 운영 실습]]에서 이어진다.
- p.23의 Pod 직접 통신·Log를 다시 검증하려면 새 EKS 환경에서 관련 Manifest를 복원한다.
