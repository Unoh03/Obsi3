...
AWS는 믿을 수 있는 보안 사례를 제공하며, 기업과 공공 기관이 선택하는 기본 클라우드 솔루션으로 제시된다.
...
|비용 최적화|지출 분석 및 귀속, 비용 효율적인 리소스 사용, 추측 기반 결정 지양|
...
| 파일 p. | 교재 p. | 내용 | 상태 | 이미지/도식 처리 | 분리 후보 |
|---:|---:|---|---|---|---|
| 1 | 27 | 모듈 표지 | preserved | 표지 이미지 생략 | 없음 |
| 2 | 28 | 도입 확인 질문 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 3 | 29 | 모듈 개요 | preserved | 목록화 | 구조 기준 |
| 4 | 30 | CTO 비즈니스 요청 | preserved | 질문 목록 보존 | Concept 후보 |
| 5 | 31 | AWS 서비스 섹션 표지 | preserved | 제목/질문 보존 | Concept 후보 |
| 6 | 32 | Amazon Web Services 개요 | preserved | 지도 생략, 핵심 특징 보존 | Concept 후보 |
| 7 | 33 | 고객이 AWS로 이전하는 이유 | preserved | 도식 표/목록화 | Concept 후보 |
| 8 | 34 | AWS 서비스 범주 | preserved | 아이콘 그리드 표/목록화 | MOC 후보 |
| 9 | 35 | AWS 인프라 섹션 표지 | preserved | 제목/질문 보존 | Concept 후보 |
| 10 | 36 | AWS 인프라 관련 주제 | preserved | 계층 목록화 | Concept 후보 |
| 11 | 37 | AWS 데이터 센터 | preserved | 건물/아이콘 생략 | Concept 후보 |
| 12 | 38 | 가용 영역 | preserved | 관계 구조 텍스트화 | Concept 후보 |
| 13 | 39 | AWS 리전 | preserved | 지도 생략, 리전-AZ 관계 보존 | Concept 후보 |
| 14 | 40 | 리전 선택 요인 | preserved | 4요인 표 변환 | Concept 후보 |
| 15 | 41 | AWS Local Zones | preserved | 사용 사례/구성 요소 목록화 | Concept 후보 |
| 16 | 42 | 엣지 로케이션 | preserved | 지도 생략, 기능 목록화 | Concept 후보 |
| 17 | 43 | 엣지 로케이션 사용 사례 | preserved | Mermaid 후보, 원본 이미지 보존 후보 | Concept 후보 |
| 18 | 44 | Local Zones 및 Edge Location 비교 | preserved | 비교표 변환 | Concept 후보 |
| 19 | 45 | AWS Well-Architected Framework 표지 | preserved | 제목/질문 보존 | Concept 후보 |
| 20 | 46 | AWS 아키텍트 역할 | preserved | 3열 도식 표 변환 | Concept 후보 |
| 21 | 47 | Well-Architected 6개 핵심 요소 | preserved | 6 pillar 표 변환 | Concept 후보 |
| 22 | 48 | 지속 가능성 및 WA Tool 참고 | preserved | 링크/목록 보존 | Reference 후보 |
| 23 | 49 | AWS Well-Architected Tool | preserved | Mermaid 후보 | Concept 후보 |
| 24 | 50 | 검토 섹션 표지 | preserved | 제목 보존 | 없음 |
| 25 | 51 | 솔루션 제시 | preserved | 질문/답변 텍스트화 | Concept 후보 |
| 26 | 52 | 모듈 복습 | preserved | 체크리스트화 | Appendix 후보 |
| 27 | 53 | 지식 확인 표지 | preserved | 제목 보존 | Appendix 후보 |
| 28 | 54 | 지식 확인 문제 1 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 29 | 55 | 문제 1 정답/해설 | preserved | 정답/해설 보존 | Appendix 후보 |
| 30 | 56 | 지식 확인 문제 2 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 31 | 57 | 문제 2 정답/해설 | preserved | 정답/해설 보존 | Appendix 후보 |
| 32 | 58 | 지식 확인 문제 3 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 33 | 59 | 문제 3 정답/해설 | preserved | 정답/해설 보존 | Appendix 후보 |
| 34 | 60 | 지식 확인 문제 4 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 35 | 61 | 문제 4 정답/해설 | preserved | 정답/해설 보존 | Appendix 후보 |
| 36 | 62 | 지식 확인 문제 5 | preserved | 문제/보기 텍스트화 | Appendix 후보 |
| 37 | 63 | 문제 5 정답/해설 | preserved | 정답/해설 보존 | Appendix 후보 |
| 38 | 64 | 실습 1 표지 | preserved | 제목 보존 | Lab 후보 |
| 39 | 65 | AWS 서비스 연결 도구 | preserved | Mermaid 변환 | Lab/Concept 후보 |
| 40 | 66 | 실습 과제 | preserved | 체크리스트 변환 | Lab 후보 |
| 41 | 67 | 모듈 1 완료 | preserved | 문의 링크 보존 | 없음 |
...
| 후보 노트 | 근거 페이지 | 분리 판단 |
|---|---:|---|
| `Concept - AWS 아키텍처 판단 프레임` | p.30, p.46, p.51, p.54~55 | 모듈 전체의 중심축이다. Source Digest 검수 후 별도 개념 노트로 분리 가능 |
| `Concept - AWS 서비스와 클라우드 이전 이유` | p.31~34 | AWS 사용 이점과 서비스 범주를 묶어 정리할 때 분리 |
| `MOC - Architecting on AWS 전체 서비스 범주` | p.34 | 모듈 2~13까지 연결하는 서비스 범주 지도가 필요할 때 분리 |
| `Concept - AWS 글로벌 인프라` | p.35~44 | 데이터 센터, AZ, Region, Local Zones, Edge Location을 한 번에 복습할 때 분리 |
| `Concept - Region vs Availability Zone` | p.38~39, p.56~57, p.60~61 | 초보자 혼동 가능성이 높으므로 별도 비교 노트 후보 |
| `Concept - AWS 리전 선택 기준` | p.40, p.58~59 | 거버넌스, 지연 시간, 서비스 가용성, 비용 기준을 프로젝트 리전 선택에 연결할 때 분리 |
| `Concept - AWS Local Zones vs Edge Location` | p.41~44 | 사용자 근접 실행 환경과 콘텐츠 캐시 지점의 차이를 정리할 때 분리 |
| `Concept - CloudFront와 Edge Location` | p.42~43 | CloudFront 배포 학습 시 분리 |
| `Concept - AWS Well-Architected Framework` | p.45~51, p.62~63 | 6개 pillar와 설계 검토 기준을 정리할 때 분리 |
| `Concept - AWS Well-Architected Tool` | p.49 | 워크로드 검토 도구로 별도 정리할 때 분리 |
| `Concept - AWS API와 관리 도구` | p.65 | Console, CLI, SDK, API 관계를 정리할 때 분리 |
| `Concept - Console vs CLI vs SDK` | p.65 | AWS 조작 방식 비교가 필요할 때 분리 |
| `Reference - AWS Well-Architected 관련 링크` | p.48~49 | 공식 링크 모음이 필요할 때 분리 |
| `Appendix - 모듈 1 지식 확인` | p.52~63 | 문제/보기/정답/해설을 별도 복습 자료로 분리할 때 사용 |
| `Appendix - 모듈 1 도입 확인 질문` | p.28 | 도입 질문을 지식 확인과 분리 관리할 때 사용 |
| `Lab - AWS Console과 AWS CLI로 S3 조작하기` | p.64~66 | 실제 실습 로그, 명령어, 스크린샷을 추가할 때 분리 |
...
| 위치 | 항목 | 조치 |
|---|---|---|
| p.62 / 파일 p.36 | `신뢰성`과 `안정성` 번역 혼용 | 같은 Well-Architected `Reliability` pillar를 가리키는 표현으로 메모 유지 |

---

# 정리 상태

- Source Digest 본문 범위: 파일 p.1~41 / 교재 p.27~67
- 페이지 반영 상태: 전 페이지 `preserved`
- 이미지 처리 원칙: 기본 텍스트화, 구조 손실 가능성이 있는 도식만 Mermaid 또는 이미지 보존 후보 처리
- PDF 대조 검수 상태: 완료
- 수정 반영:
  - p.32 / 파일 p.6: PDF 근거가 약한 “중앙집중형 모델” 표현 제거
  - p.47 / 파일 p.21: `비용 최적화` 예시 문구를 “지출 분석 및 귀속”으로 수정
- 다음 단계: Concept Wiki 분리 여부 판단
