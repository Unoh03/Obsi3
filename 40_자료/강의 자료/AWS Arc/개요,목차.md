...
source: "[[40_자료/강의 자료/AWS Arc/Architecting on AWS 7.10.4 (개요,목차).pdf]]"
source_pages: [1-26]
---
# Architecting on AWS 7.10.4 - 개요와 목차

> [!note]
> 이 노트는 PDF 내용을 학습 노트로 재해석하기 전 만든 미승인 Source Digest 초안이다.
> PDF에 반복되는 인쇄자 워터마크와 저작권 문구는 페이지마다 반복하지 않고 문서 메타 정보로만 기록한다.
> 공식 탐색은 [[40_자료/강의 자료/AWS Arc/README|Architecting on AWS 원본 PDF 목차]]에서 시작하고, 내용 판단은 [[40_자료/강의 자료/AWS Arc/Architecting on AWS 7.10.4 (개요,목차).pdf|원본 PDF]]를 기준으로 한다.
...
- [[40_자료/강의 자료/AWS Arc/README|Architecting on AWS 원본 PDF 목차]]
- [[40_자료/강의 자료/AWS Arc/Architecting on AWS 7.10.4 (개요,목차).pdf|개요·목차 원본 PDF]]
...
이미지 placeholder: `Architecting-on-AWS-overview-p019-capstone-architecture.png`

> [!note]
> 현재 vault에는 위 이미지 파일이 없다. 캡스톤 아키텍처 다이어그램이 필요하면 원본 PDF p.19를 다시 확인한다.
