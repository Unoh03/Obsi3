...
- [ ] 웹보안 stable / RAW / PDF source 경계 점검
  ...
  - Next check: `File Upload와 Webshell / Directory Listing` 범위를 점검한다. PDF p.133-136을 기준으로, 기존 [[10_학습 노트/시스템보안/웹보안/File Upload와 Webshell|File Upload와 Webshell]], [[10_학습 노트/시스템보안/웹보안/Directory Listing 취약점|Directory Listing 취약점]], [[10_학습 노트/시스템보안/웹보안/웹쉘 Upload 및 실행 실습|웹쉘 Upload 및 실행 실습]]의 stable/lab 경계가 충분한지 먼저 확인한다.
...
- [ ] 시스템보안 전체 재시작 지점 점검
  ...
  - Next check: File Upload / Directory Listing, DHCP Snooping, IP Source Guard, Wireshark 필터를 실제 후보 노트 단위로 쪼갤지 판단한다.
